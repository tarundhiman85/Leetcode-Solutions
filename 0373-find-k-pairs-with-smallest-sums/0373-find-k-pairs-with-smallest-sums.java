...
/*
1-2, 1-4, 1-6    we have k iterations in this example

x1,x2,x3,x4,x5,x6,x7....yn       y1,y2,y3,y4,y5,y6,y7 ....ym
 
 we need k pairs
 
 x1,y1,x2,y2,x3,y3,x4,y4......xn,xm   brute force
 
 creating pairs in this approach will take max k * (n+m) time
 
 it can happen that n and m < k
