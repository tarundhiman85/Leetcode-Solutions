...
/*
mask each skill and create a bit mask and represent each subject as a bit
mask each people and create a bit mask
ending condition is the fulfillment of the bitmask and in minimum number of ways
*/